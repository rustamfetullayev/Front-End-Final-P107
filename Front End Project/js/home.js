...
order.onclick=function(){
    if(formname.value=="" || formemail.value=="" || formmessage.value==""){
        formname.parentNode.style.borderColor="red";
        formemail.parentNode.style.borderColor="red";
        formmessage.parentNode.style.borderColor="red";
    }
    else if(formemail.value.indexOf("@")==-1){
        formemail.parentNode.style.borderColor="red";
    }
    else{
        formname.parentNode.style.borderColor="green";
        formemail.parentNode.style.borderColor="green";
        formmessage.parentNode.style.borderColor="green";
    }
}
